...
namespace Xceed.Wpf.AvalonDock.Controls {
	public abstract class LayoutFloatingWindowControl : Window, ILayoutControl {
		...
		static LayoutFloatingWindowControl() {
			...
			SnapsToDevicePixelsProperty.OverrideMetadata(typeof(LayoutFloatingWindowControl), new FrameworkPropertyMetadata(true));
			UseLayoutRoundingProperty.OverrideMetadata(typeof(LayoutFloatingWindowControl), new FrameworkPropertyMetadata(true));
		}
