...
namespace ZeldaOracle.Common.Graphics {
	...
	public class PaletteDictionary {
		...
		public PaletteDictionary(PaletteDictionary copy) {
			parentDictionary	= copy.parentDictionary;
			indexMap			= new Dictionary<string, int>(copy.indexMap);
			type				= copy.type;
		}
		...
		public Color GetMappedColor(string name, LookupSubtypes subtype) {
			...
			switch (type) {
			case PaletteTypes.Tile:   color.B = TileBlue;   break;
			case PaletteTypes.Entity: color.B = EntityBlue; break;
			}
			return color;
		}
