...
namespace ZeldaOracle.Common.Graphics.Sprites {
	...
	public class OffsetSprite : ISprite {
		...
		public OffsetSprite() {
			...
			clipping		= null;
			flipEffects		= Flip.None;
			rotation		= Rotation.None;
		}

		/// <summary>Constructs an offset sprite with the specified sprite and
		/// settings.</summary>
		public OffsetSprite(ISprite sprite, Rectangle2I? clipping = null,
		...
		/// <summary>Gets or sets the extra number of 90-degree rotations for the
		/// sprite.</summary>
