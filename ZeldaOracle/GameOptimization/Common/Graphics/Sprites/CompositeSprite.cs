...
namespace ZeldaOracle.Common.Graphics.Sprites {
	...
	public class CompositeSprite : ISprite {
		...
		public void AddSprite(ISprite sprite, Rectangle2I? clipping = null,
		...
		{
			AddOffsetSprite(new OffsetSprite(sprite, drawOffset, clipping, flip,
				rotation));
		}
		...
		public void InsertSprite(int index, ISprite sprite,
			...
			Rotation rotation = Rotation.None)
		{
			InsertOffsetSprite(index, new OffsetSprite(sprite, clipping, flip,
				rotation));
		}
		...
		public void InsertSprite(int index, ISprite sprite, Point2I drawOffset,
			...
			Rotation rotation = Rotation.None)
		{
			InsertOffsetSprite(index, new OffsetSprite(sprite, drawOffset, clipping,
				flip, rotation));
		}
