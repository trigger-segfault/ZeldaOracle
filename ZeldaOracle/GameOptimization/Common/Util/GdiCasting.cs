...
namespace ZeldaOracle.Common.Util {
	...
	public static class GdiCasting {
		...
		/// <summary>Casts the Zelda Color to a Gdi Color.</summary>
		...
		/// <summary>Casts the Zelda Point2I to a Gdi Point.</summary>
		public static GdiPoint ToGdiPoint(this Point2I point) {
			return new GdiPoint(point.X, point.Y);
		}

		/// <summary>Casts the Zelda Vector2F to a Gdi Point.</summary>
		...
		/// <summary>Casts the Zelda Point2I to a Gdi PointF.</summary>
		...
		/// <summary>Casts the Zelda Point2I to a Gdi Size.</summary>
		...
		/// <summary>Casts the Zelda Point2I to a Gdi SizeF.</summary>
		...
		/// <summary>Casts the Zelda Rectangle2I to a Gdi Rectangle.</summary>
		...
		/// <summary>Casts the Zelda Rectangle2F to a Gdi Rectangle.</summary>
