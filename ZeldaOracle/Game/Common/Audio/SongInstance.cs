...
namespace ZeldaOracle.Common.Audio {
	...
	public class SongInstance {
		...
		public SongInstance(SoundEffectInstance soundInstance, Song song,
			...
			float pan = 0.0f)
		{
			...
			this.soundInstance.Volume	= GMath.Clamp(AudioSystem.MusicVolume *
				volume, 0.0f, 1.0f);
			this.soundInstance.Pitch	= GMath.Clamp(AudioSystem.MasterPitch +
				AudioSystem.MusicPitch + pitch, -1.0f, 1.0f);
			this.soundInstance.Pan		= GMath.Clamp(AudioSystem.MasterPan +
				AudioSystem.MusicPan + pan, -1.0f, 1.0f);
		...
		internal void Update() {
			soundInstance.Volume    = GMath.Clamp(AudioSystem.MusicVolume *
				volume, 0.0f, 1.0f);
