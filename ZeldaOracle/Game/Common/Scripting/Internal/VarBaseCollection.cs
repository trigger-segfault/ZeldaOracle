...
namespace ZeldaOracle.Common.Scripting.Internal {
	...
	public abstract class VarBaseCollection<VarBaseType> where VarBaseType : VarBase {
		...
		/// <summary>The available actions for SetVarElement.</summary>
		/*protected enum ElementAction {
			Set,
			Add,
			Insert,
			Remove,
		...
		/// <summary>Sets the var's element.</summary>
		//protected abstract VarBaseType SetVarElement(string name, int index, object value,
