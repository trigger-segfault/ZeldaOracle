...
namespace ZeldaOracle.Common.Geometry {
	...
	public struct Rectangle2F {
		...
		// Constructs a rectangle with the specified size.
		...
		// Outputs a string representing this rectangle.
		...
		// Returns true if the specified rectangle has the same x and y coordinates.
		...
		// Returns the point on the rectangle based on the its perimeter.
		...
		// Returns a rectangle with the corners stretched out by the specified amount.
		...
		// Returns true if the specified vector is colliding with this rectangle.
		...
		// Stretches the corners of the rectangle out by the specified amount.
		...
		// Returns true if the rectangle has an size of zero.
		public bool IsEmpty {
		...
		// Gets the number of points in the rectangle.
		public int NumPoints {
			get { return 2; }
		}

		// Gets the number of lines in the rectangle.
		public int NumLines {
			get { return 1; }
		}

		// Gets the list of points in the rectangle.
		...
		// Gets the list of lines in the rectangle.
		public Line2F[] Lines {
			get {
				return new Line2F[] {
