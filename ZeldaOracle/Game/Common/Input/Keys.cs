...
namespace ZeldaOracle.Common.Input {
	/// <summary>The control codes for each of the keys on a keyboard.</summary>
	public enum Keys {
		...
		/// <summary>The launch mail key (Windows 2000 or later). </summary><summary>
		LaunchMail = 0xB4,
		...
		#endregion
		//--------------------------------
		#region Original Equipment Manufacturer (OEM) Keys

		/// <summary>The OEM ';:' key on a US standard keyboard (Windows 2000 or later).</summary>
		Semicolon = 0xBA,
		/// <summary>The OEM 1 key.</summary>
		Oem1 = 0xBA,
		/// <summary>The OEM '+=' key on any country/region keyboard (Windows 2000 or later).</summary>
		Equals = 0xBB,
		/// <summary>The OEM ',<' key on any country/region keyboard (Windows 2000 or later).</summary>
		Comma = 0xBC,
		/// <summary>The OEM '-_' key on any country/region keyboard (Windows 2000 or later).</summary>
		Minus = 0xBD,
		/// <summary>The OEM '.>' key on any country/region keyboard (Windows 2000 or later).</summary>
		Period = 0xBE,
		...
		#endregion
		//--------------------------------
		#region Input Method Editor (IME) Keys
		...
		IMENonconvert = 0x1D,
		/// <summary>The IME accept key, replaces System.Windows.Forms.Keys.IMEAceept.</summary>
		IMEAccept = 0x1E,
		/// <summary>The IME accept key. Obsolete, use System.Windows.Forms.Keys.IMEAccept instead.</summary>
		IMEAceept = 0x1E,
