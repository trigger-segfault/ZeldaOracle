...
namespace ZeldaOracle.Game.Control.Scripting {
	...
	public class ScriptManager {
		...
		//	string code = CreateUsingsString() + "\n";
		...
		//	// Iterate through all defined trigger scripts
		//	if (world != null) {
		//		int internalID = 0;
		...
		//public static string CreateTestTriggerFunction(World world,
		//	Type objectType, string triggerScriptCode, out int scriptStart)
		//{
		//	string code = CreateUsingsString();
		//	code += CreateUsingsString() + "\n";
		//	code += CreateNamespaceOpening() + "\n";

		//		// scripts interface
		//		code += CreateUserScriptsInterface(world) + "\n";

		//		// static trigger class and function
		//		code += CreateTriggerFunctionOpening(objectType);
		//			scriptStart = code.Length;
		//			code += triggerScriptCode;
		//		code += CreateTriggerFunctionClosing();

		//	code += "\n" + CreateNamespaceClosing();
		//	return code;
		//}

		///// <summary>Create the static class which contains the trigger script
		///// function.</summary>
		//public static string CreateTriggerFunctionOpening(Type objectType) {
		//	string code = "    public static class CustomTriggerFunction {\n";
		//	code += "        public static void CustomTriggerScript(\n";
		//	if (objectType == null)
		//		objectType = typeof(object);
		//	code += "            " + objectType.Name + " This,\n";
		//	code += "            ScriptActions Actions,\n";
		//	code += "            ScriptFunctions Functions,\n";
		//	code += "            UserScripts Scripts";
		//	code += ")\n";
		//	code += "        {\n";
		//	return code;
		//}

		//public static string CreateTriggerFunctionClosing() {
		//	return	"        }\n" +
		//			"    }\n";
		//}

		//public static string CreateUserScriptsInterface(World world) {
		//	string code = "    public interface UserScripts {\n";
		...
		//public static string CreateNamespaceOpening() {
		//	return	"namespace ZeldaAPI.CustomScripts {\n";
		//}
		
		//public static string CreateNamespaceClosing() {
		//	return	"}\n";
		//}
