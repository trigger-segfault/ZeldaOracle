...
public class PropertyInt : Property {
	...
	public PropertyInt()
		...
		this.range			= RangeI.Full;
	}
	/** <summary> Constructs the default property. </summary> */
	public PropertyInt(string name, int value, int defaultValue, RangeI range, PropertyAction action = null)
	...
	public override string Text {
		set {
			...
			int newValue = 0;
			try {
				newValue = GMath.Clamp(Int32.Parse(value), range.Min, range.Max);
			}
	...
	public override void Finish() {
		...
		int newValue = 0;
		try {
			newValue = GMath.Clamp(Int32.Parse(editingText), range.Min, range.Max);
		}
		catch (FormatException e) {
			error = true;
		}
