...
namespace ZeldaOracle.Game.Tiles {
	...
	public class TilesetOld : BaseTileset<TileData> {
		...
		public TilesetOld(string id, SpriteSheet sheet, Point2I size) :
			this(id, sheet, size.X, size.Y)
		{
		}

		public TilesetOld(string id, SpriteSheet sheet, int width, int height) :
