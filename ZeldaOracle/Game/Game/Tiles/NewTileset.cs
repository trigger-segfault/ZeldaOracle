...
namespace ZeldaOracle.Game.Tiles {
	public class NewTileset : ITileset {
		...
		public NewTileset(string id, int width, int height, bool usePreviewSprites = true) {
			this.id					= id;
		...
		/// <summary>Constructs a new tileset with the specified ID and dimensions.</summary>
		public NewTileset(string id, Point2I dimensions, bool usePreviewSprites = true) {
			this.id					= id;
		...
		public NewTileset(NewTileset copy) {
			this.id					= copy.id;
