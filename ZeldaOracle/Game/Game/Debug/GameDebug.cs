	...
	public class GameDebug {
		...
		public static World CreateTestWorld() {
			...
			t = r.CreateTile(tdOwl, 8, 1, 1);
				t.ModifiedProperties.Set("text", "Hello, World!");
			t = r.CreateTile(tdChest, 7, 1, 1);
				t.ModifiedProperties.Set("reward", "heart_piece");
			t = r.CreateTile(tdReward, 6, 3, 1);
				t.ModifiedProperties.Set("reward", "item_flippers_1");
			t = r.CreateTile(tdSign, 1, 1, 1);
				t.ModifiedProperties.Set("text", "This will<n> prime your load catchers and boost your desktop wallpaper.");
