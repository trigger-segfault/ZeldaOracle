...
namespace ZeldaAPI {
	...
	public interface Lantern : Tile {
		...
		void PutOut(bool stayLit = false);
	...
	public interface ColorSwitch : Tile {
		/**<summary>Gets the color of the color switch tile. This can only be red or blue.</summary>*/
		Color Color { get; }
	}
	...
	public interface MinecartTrack : Tile {
		/**<summary>Switches the track to the switched orientation or back to the regular orientation.</summary>*/
